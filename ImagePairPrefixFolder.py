...
from utils import batch_edge_compute,batch_Dark_Channel_compute
...
def var_custom_collate(batch):
    ...
    batch_input_Dark_Channel = batch_Dark_Channel_compute(batch_input_images) - 128
    return batch_input_images, batch_input_edges, batch_input_Dark_Channel,  batch_gt_images
